...
1. **Carpeta raíz** — elige la carpeta que contiene tus imágenes (buscará en todas las subcarpetas)
2. **Carpeta de destino** — elige dónde guardar las imágenes clasificadas
...
**Ana Maraboli**  
[@AnaMaraboli](https://github.com/AnaMaraboli)  
